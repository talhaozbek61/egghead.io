...
const Footer = () => {
  ...
  return (
    <footer className="max-w-7xl mx-auto pb-6">
      <div className="flex md:flex-row flex-col items-start justify-between gap-6 px-6 mx-auto pt-16 pb-16 md:pt-14 lg:pb-40 w-full">
        <div className="md:flex items-start md:mx-0 mx-auto space-x-2 max-w-[18rem]">
          <a className="flex-inital mx-auto" href="/">
            <img
              src={logo}
              alt="Logo"
              className="w-8 h-8 md:inline-block shrink-0 mx-auto"
            />
          </a>
          <span className="text-xl font-semibold tracking-tight leading-tighter w-[248px] inline-flex flex-inital text-center mt-2 md:mt-0 md:text-start">
        ...
        <div className="grid md:grid-cols-2 md:gap-10 md:text-left lg:pr-6 md:items-start text-center md:mx-0 mx-auto">
          ...
          <div>
            <ul className="list-none" id="list">
              ...
              <li>
                <a href="/">egghead for teams</a>
              </li>
              <li>
                <a href="/">Store</a>
              </li>
              <li>
                <a href="/">support@egghead.io</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="flex items-center justify-center space-x-6 text-xs text-gray-500 md:justify-end dark:text-gray-300 md:mx-0 mx-auto sm:w-[98%] w-full">
        ...
        <a href="/">FAQ</a>
        <div id="mode" className="hidden sm:inline-block">
          Light Mode
        </div>
        <button
          className="w-16 h-10 p-1 rounded-full bg-gray-300 dark:bg-gray-950 flex items-center transition duration-300 focus:outline-none shadow mx-auto"
          onClick={changeMode}
        >
          <div
            id="switch-toggle"
            className="bg-white w-8 h-8 relative rounded-full transition duration-500 transform p-1 text-white dark:bg-gray-800 dark:text-white flex justify-center items-center"
          >
            <svg
